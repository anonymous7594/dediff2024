...
class DeformNetwork(nn.Module):
    ...
    def forward(self, x, t):
        ...
        return d_xyz, rotation, scaling, h
    ...
    #def forward(self, time_input, xyz, new_feature_latent_data):    
        ...
        if new_feature_latent_data.numel() == 0:
            ...
            if new_feature_latent_data.ndimension() == 3:
                ...
                num_elements_needed = xyz_embed.shape[0] * self.Wi
                ...
                reshaped_image_latent_data = padded_image_latent_data.reshape(xyz_embed.shape[0], self.Wi)
