    ...
    #def forward(self, time_input, xyz, new_feature_latent_data):    
        ...
        if new_feature_latent_data.numel() == 0:
            ...
            if new_feature_latent_data_all == []:
                ...
                #camera_pose_embedding = camera_pose_embedding.view(1, 1, 1, 60)
                ...
                new_feature_latent_data_all = self.decoder_latent_compilation(new_feature_latent_data_all)
                                                                                #+ self.time_embedding(time_input[0,:]).expand(new_feature_latent_data_all.shape[0], 4, 33, 60)
                                                                                #+ camera_pose_embedding.expand(new_feature_latent_data_all.shape[0], 4, 33, 60)
                                                                                #                        ) 
                # Flatten the tensor to 1D
