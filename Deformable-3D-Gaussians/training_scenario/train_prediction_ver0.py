...
def training(dataset, opt, pipe, testing_iterations, saving_iterations):
    ...
    for iteration in range(1, opt.iterations + 1):
        ...
        # UPDATE: BY FRAME ORDER
        print('NEW TRAINING 20/05/2024 ver 1')
        ...
        if (frame_number == 0) or (frame_number == (total_frame-1)) or (frame_number % 5 == 0):
            ...
            if iteration < opt.warm_up:
                ...
                #Naive average
                d_xyz = d_xyz_before*perc_before + d_xyz_after*perc_after
                d_rotation = d_rotation_before*perc_before + d_rotation_after*perc_after
                d_scaling = d_scaling_before*perc_before + d_scaling_after*perc_after
