...
def training(dataset, opt, pipe, testing_iterations, saving_iterations):
    ...
    frame_number = 0
    print('NEW TRAINING 27/05/2024 ver 1')
    ...
    for iteration in range(1, opt.iterations + 1):
        ...
        if (frame_number == 0) or (frame_number == (total_frame-1)) or (frame_number % 10 == 0):
            ...
            if iteration < opt.warm_up:
                ...
                # After
                time_diff_after = abs(time_input_after - time_input)
                ...
                # Predict
                d_xyz, d_rotation, d_scaling = deform_predict.step(d_xyz_before, d_xyz_after,d_rotation_before,d_rotation_after,d_scaling_before,d_scaling_after)
