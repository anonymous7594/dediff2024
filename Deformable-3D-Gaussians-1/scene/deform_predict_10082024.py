...
class DeformPredict:
    ...
    def step(self, time_input,time_input_before,time_input_after,d_xyz_before, d_xyz_after, new_feature_latent_data): #features_before, features_after): #, d_xyz_current):
        return self.deform(time_input,time_input_before,time_input_after,d_xyz_before, d_xyz_after, new_feature_latent_data) # features_before, features_after)
